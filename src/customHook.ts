...
export const useTodoModalManage =(initValue:todo, closeAddModal:modalFunc, closeDeleteModal: modalFunc, closeEditModal: modalFunc, showEditModal: modalFunc, showDeleteModal: modalFunc) => {
    ...
    return {values, onChange: valueSet, handleClickAdd, handleClickDelete, handleClickEdit, handleTodoCheckChange, todoVal, selectTodoId, handleClickCancelModal, alertText, handleClickShowEditModal, handleClickShowDeleteModal}
}